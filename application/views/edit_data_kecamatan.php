...
<form method="post" action ="<?php echo base_url ('kecamatan/edit_data_kecamatan'); ?>">
<input type="hidden" name="id" value="<?php echo  $tbl_kecamatan['id'];?>">
    ...
    <select name="kd_p" id="kd">
      <?php
        foreach ($tbl_provinsi as $prov) {?>
          <option value="<?= $prov['kd_prov'] ?>" <?= $prov['kd_prov'] == $tbl_kecamatan['kd_prov'] ? 'selected' : '' ?>><?= $prov['provinsi'] ?></option>
        <?php } ?>
    </select>
  </div>
</div>
    ...
    <select name="kd_k" id="kd">
      <?php
        foreach ($tbl_kabupatenn as $kab) {?>
          <option value="<?= $kab['kd_kab'] ?>" <?= $kab['kd_kab'] == $tbl_kecamatan['kd_kab'] ? 'selected' : '' ?>><?= $kab['kabupaten'] ?></option>
        <?php } ?>
    </select>
  </div>
</div>
<div class="from-gruop row">
    ...
    required="" value="<?php echo $tbl_kecamatan['kd_kec'];?>">
  </div>
</div>
<div class="from-gruop row">
    ...
    required="" value="<?php echo $tbl_kecamatan['kecamatan'];?>">
  </div>
</div>
<div class="from-gruop row">
